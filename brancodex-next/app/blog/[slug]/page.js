            ...
            >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.6rem" }}>
                {[
                  {
                    href: "/",
                    label: "BranCodeX — Professional Web Development Agency",
                  },
                  { href: "/contact", label: "Get a Free Quote" },
                  {
                    href: "/blog/best-web-developer-in-cameroon",
                    label: "Best Web Developer in Cameroon",
                  },
                  {
                    href: "/blog/best-web-developer-in-africa",
                    label: "Best Web Developer in Africa",
                  },
                  {
                    href: "/blog/best-web-developer-in-the-world",
                    label: "Best Web Developers in the World",
                  },
                  {
                    href: "/blog/web-development-services-cameroon",
                    label: "Web Development Services",
                  },
                  {
                    href: "/blog/how-much-does-a-website-cost-in-cameroon",
                    label: "Website Pricing Guide",
                  },
                  {
                    href: "/blog/how-to-rank-your-business-on-google-in-cameroon",
                    label: "SEO Guide for Businesses",
                  },
                  { href: "/faq", label: "FAQ" },
                ].map(({ href, label }) => (
                  <Link
