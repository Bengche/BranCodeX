      ...
      >
        ...
        >
          ...
          <Section title="1. Who We Are">
            <p>
              BranCodeX (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;)
              is a web development agency legally registered in Cameroon as{" "}
              <strong style={{ color: "#e2e8f0" }}>BRANCODEX SARL</strong>{" "}
              (RCCM&nbsp;RC/EBWA/2026/B/65 &mdash; NIU&nbsp;M052618656154Z),
              based in Bamenda, Cameroon. We build websites and digital products
              for clients worldwide. You can reach us at{" "}
              <a
          ...
          <Section title="2. What Data We Collect">
            ...
            <ul>
              ...
              <li>
                ...
                declined our cookie notice. We do not use advertising or
                tracking cookies.
              </li>
            </ul>
            <p>
              We do <strong style={{ color: "#e2e8f0" }}>not</strong> collect
              payment card data, passwords, or any sensitive personal
              information.
            </p>
          </Section>
          ...
          <Section title="4. Legal Basis for Processing (GDPR)">
            ...
            <ul>
              ...
              <li>
                ...
                — processing data needed to deliver a service you have
                requested.
              </li>
            </ul>
          </Section>
          ...
          <Section title="5. Third-Party Services">
            ...
            <ul>
              <li>
                <strong style={{ color: "#e2e8f0" }}>EmailJS</strong> —
                transmits contact form data to our email inbox. Their privacy
          ...
          <Section title="6. Data Retention">
            <p>
              ...
              long as necessary to complete your request, then deleted. We do
              not maintain a separate database of enquiries.
            </p>
          </Section>
          ...
          <Section title="8. Cookies">
            <p>
              ...
              placed. You can clear cookies at any time via your browser
              settings.
            </p>
          </Section>
          ...
          <Section title="9. Security">
            <p>
              ...
              on every response. No system is 100% secure, but we take
              reasonable technical measures to protect your data in transit.
            </p>
          </Section>
          ...
          <Section title="10. Children's Privacy">
            <p>
              ...
              child has submitted data to us, please contact us and we will
              delete it promptly.
            </p>
          </Section>
          ...
          <Section title="11. Changes to This Policy">
            <p>
              ...
              the most recent revision. Continued use of our website after an
