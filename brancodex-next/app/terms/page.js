        ...
        >
          ...
          <Section title="1. Agreement to Terms">
            <p>
              ...
              Bamenda, Cameroon &mdash; for web development services or by using
              this website, you (&ldquo;Client&rdquo;, &ldquo;you&rdquo;) agree
          ...
          <Section title="3. Project Process & Timeline">
            <p>
              ...
              timeline. Timelines are estimates, not guarantees. Delays caused
              by late delivery of client materials (content, images, feedback)
              are not the responsibility of BranCodeX and may extend the
              timeline without penalty.
            </p>
            <p>
              We will keep you updated throughout the project with regular
              check-ins. You are expected to provide feedback within a
              reasonable timeframe (typically 3&ndash;5 business days per
              revision round).
            </p>
          </Section>
          ...
          <Section title="4. Payment">
            ...
            <ul>
              ...
              <li>
                The remaining <strong style={{ color: "#e2e8f0" }}>50%</strong>{" "}
                is due upon project completion, before the final files or live
          ...
          <Section title="6. Intellectual Property">
            ...
            <p>
              ...
              ensure you have the appropriate licences for any content you
              provide to us.
            </p>
          </Section>
          ...
          <Section title="10. Limitation of Liability">
            ...
            <p>
              We are not responsible for third-party services (hosting
              providers, domain registrars, payment gateways) used by your
              website after handover.
            </p>
          </Section>
